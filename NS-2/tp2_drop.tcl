...
#open output files
set f0 [open tp2_drop_out0.tr w]
set f1 [open tp2_drop_out1.tr w]
set f2 [open tp2_drop_out2.tr w]
...
proc finish {} {
	...
	#Execute nam on the trace file
        exec xgraph tp2_drop_out0.tr tp2_drop_out1.tr tp2_drop_out2.tr -geometry 800x400 &
        exec nam out.nam 
        exit 0
}
...
$ns duplex-link $n6 $n2 10Mb 1ms DropTail
